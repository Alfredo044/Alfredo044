Ito yung **designed GitHub Profile README** using **Markdown + HTML + badges**. Copy-paste mo ito sa `README.md`.
...
Palitan mo lang yung **YOUR_GITHUB_USERNAME** ng actual GitHub username mo para gumana yung GitHub stats.
